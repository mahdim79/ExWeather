...
import kotlinx.android.synthetic.main.fragment_forecast_details_viewpager.view.forecastDetailsRecyclerView
import kotlinx.android.synthetic.main.fragment_history_details_viewpager.*

class HistoryDetailsViewPagerFragment(
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_history_details_viewpager, container, false)
    }
        ...
        data.observe(viewLifecycleOwner) {
            ...
            it.forEach { weatherEntity ->
                ...
                if (data.location == location)
                    data.historyDetailsData!!.forecast.forecastday.forEach { forecastDay ->
    ...
    private fun setUpPrimaryRecyclerView() {
        requireView().apply {
            ...
            historyDetailsRecyclerView.layoutManager =
                LinearLayoutManager(requireContext(), LinearLayoutManager.VERTICAL, false)
            historyDetailsRecyclerView.adapter = recyclerViewAdapter
        }
    }
}